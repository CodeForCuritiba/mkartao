...
Template.pontos.helpers({
  ...
  modal: function() {
    var data = Session.get('modal');
    data.updated_at = moment(data.updated_at, 'HH:mm:ss');
...
Template.pontos.onCreated(function() {
  ...
  GoogleMaps.ready('map', function(map) {
    var icons = {
      'venda': new google.maps.MarkerImage('img/venda.png', null, null, null, new google.maps.Size(28 * 0.8, 55 * 0.8)),
      'posto': new google.maps.MarkerImage('img/posto.png', null, null, null, new google.maps.Size(34 * 0.7, 49 * 0.7)),
      'you': new google.maps.MarkerImage('img/you.png', null, null, null, new google.maps.Size(33 * 0.8, 33 * 0.8)),
      'veiculo': new google.maps.MarkerImage('img/veiculo.png', null, null, null, new google.maps.Size(50 * 0.5, 69 * 0.5))
    };
...
console.log(doc);
    ...
    // Observa mudanças nos pois (reativamente)
    Pois.find().observe({
    ...
    var cod = location.search.substr(1);
